...
PACKAGES = vim curl emacs24 i3 fonts-inconsolata xfce4-terminal tmux tig python2.7 python-virtualenv python-pip ipython ipython-notebook inotify-tools ack-grep chromium-browser oracle-jdk7-installer gksu nmap
